 ...
 *
 * Bootstrap (39-09/44-07, D-17/D-04): SafeAreaProvider → CadreNodeProvider → VotingAppProvider →
 * NavigationContainer (Phase 38 light/dark ExtendedTheme) → RootNavigator. Phase 44-07 mounts
 * `CadreNodeProvider` as the parent of `VotingAppProvider` (mirroring the authority app's
 * `App.tsx`) — the rewritten `VotingAppProvider` now calls `useCadreNode()` in its body and
