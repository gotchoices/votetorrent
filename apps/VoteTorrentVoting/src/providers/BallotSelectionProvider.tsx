 ...
 *
 * App-local only — does NOT import from `vote-core` and does NOT call `useVotingApp()` (this
 ...
 *
 * Pattern references: apps/VoteTorrentVoting/src/providers/RegistrationDraftProvider.tsx
