 ...
 * directly (no `VotingAppProvider`/`RegistrationDraftProvider`/navigator) since `RegistrationCard`
 * never calls `useVotingApp()` or `useNavigation()` — mirrors `ElectionCard.test.tsx`'s
