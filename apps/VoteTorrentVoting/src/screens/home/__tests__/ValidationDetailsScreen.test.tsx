 ...
 * frame `276:868`. Mounts inside VotingAppProvider + ThemeProvider (this screen calls
 * useVotingApp()/getElection() and useTheme(), unlike the pure presentational components) and
...
function Harness() {
	const {setLifecycleState} = useVotingApp();
	React.useEffect(() => {
