 ...
 * `VotingAppProvider` + real `BallotSelectionProvider` around a minimal native-stack harness (the
...
/** Flush VotingAppProvider's isInitialized boot effect + BallotScreen's getBallot().then(setBallot). */
