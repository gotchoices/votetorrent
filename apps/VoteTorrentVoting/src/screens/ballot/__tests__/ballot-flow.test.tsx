 ...
 * ballot navigation-flow test. Mounts a real `NavigationContainer` + real `VotingAppProvider` +
...
/** Flush VotingAppProvider's isInitialized boot effect + each screen's getBallot().then(setBallot). */
