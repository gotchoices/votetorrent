 ...
 * + real VotingAppProvider + real BallotSelectionProvider around a minimal native-stack harness
...
/** Flush VotingAppProvider's isInitialized boot effect + the screen's getBallot().then(setBallot). */
