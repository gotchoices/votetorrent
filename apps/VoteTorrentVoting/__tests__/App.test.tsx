...
// App.test.tsx convention (39-04 precedent). VotingAppProvider uses the manual Jest mock at
// src/providers/__mocks__/VotingAppProvider.tsx (real, stateful lifecycleState/getElection/
