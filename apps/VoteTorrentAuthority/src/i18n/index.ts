...
const resources = {
	en: {
		translation: {
			...
			onboardingDebugIntro: 'Direct entry points for the six onboarding screens. Temporary dev route per D-12; replaced by real callers in phases 8–10.',
			// Frame 2 — Invitation sent (initial confirmation)
			onboardingFrame2Title: 'Invitation Sent',
			onboardingFrame2BodyPrimary: 'Your invitation has been sent. You will be notified when the recipient responds.',
			onboardingFrame2BodySecondary: 'If no response is received soon, you can resend the invitation.',
			onboardingFrame2Resend: 'Resend Invitation',
			onboardingFrame2BackToTasks: 'Back to Tasks',
			// Frame 7 — Awaiting response
			onboardingFrame7Title: 'Awaiting Response',
			onboardingFrame7BodyPrimary: 'Waiting for the recipient to respond to your invitation.',
			onboardingFrame7BodySecondary: 'You can resend the invitation or cancel it if no longer needed.',
			onboardingFrame7Resend: 'Resend Invitation',
			onboardingFrame7CancelInvitation: 'Cancel Invitation',
			// Frame 18 — Sent confirmation
			onboardingFrame18Title: 'Request Sent',
			onboardingFrame18BodyPrimary: 'Your request has been submitted successfully.',
			onboardingFrame18GotIt: 'Got It',
			// Frame 19 — Awaiting (variant)
			onboardingFrame19Title: 'Awaiting Approval',
			onboardingFrame19BodyPrimary: 'Your submission is pending approval from the authority.',
			onboardingFrame19BodySecondary: 'You will receive a notification once it is reviewed.',
			onboardingFrame19Resend: 'Resend Request',
			onboardingFrame19DismissRequest: 'Dismiss Request',
			// Frame 20 — Release request sent
			onboardingFrame20Title: 'Release Request Sent',
			onboardingFrame20BodyPrimary: 'Your key release request has been delivered to the keyholders.',
			onboardingFrame20BackToTasks: 'Back to Tasks',
			// Frame 21 — Release awaiting
			onboardingFrame21Title: 'Awaiting Release',
			onboardingFrame21BodyPrimary: 'Waiting for keyholders to complete the release.',
			onboardingFrame21BodySecondary: 'You can resend the release request or cancel it.',
			onboardingFrame21ResendRequest: 'Resend Request',
			onboardingFrame21CancelRequest: 'Cancel Request',
		},
	},
	es: {
		translation: {
