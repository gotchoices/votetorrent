...
const mockElectionInitData: ElectionInit = {
  ...
  revision: {
    ...
    keyholders: [
      { name: 'Keyholder 1', type: 'au', expiration: '0', inviteKey: '', invitePrivate: '', inviteSignature: '', digest: '' },
      { name: 'Keyholder 2', type: 'of', expiration: '0', inviteKey: '', invitePrivate: '', inviteSignature: '', digest: '' }
    ],
    timeline: {
